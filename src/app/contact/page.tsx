      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
          ...
          <div className="animate-enter-up flex flex-col">
            ...
            <div className="hidden lg:flex flex-col gap-5 mt-8">
              ...
              >
                ...
                <div>
                  <p className="font-sans font-medium text-navy text-sm md:text-base group-hover:text-orange transition-colors">512.634.7164</p>
                  <p className="font-sans text-navy/50 text-xs">Call or text us</p>
                </div>
              </a>
        ...
        <div className="lg:hidden flex flex-col sm:flex-row sm:flex-wrap gap-6 mt-12 pt-10 border-t border-navy/10">
          ...
          >
            ...
            <span className="font-sans text-navy text-sm group-hover:text-orange transition-colors">512.634.7164</span>
          </a>
          <div className="flex items-center gap-3">
